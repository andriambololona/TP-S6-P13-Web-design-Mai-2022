	...
	<div class="breadcrumbs">
		<div class="container">
			<div class="w3layouts_breadcrumbs_left">
				<ul>
					<li><i class="fa fa-home" aria-hidden="true"></i><a href="<?php echo site_url('Accueil/index')?>">Accueil</li>
					<li><i aria-hidden="true"></li>
				</ul>
			</div>
			<div class="w3layouts_breadcrumbs_right">
				<h2><?php echo$content[0]['nom']?></h2>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
...
<!-- gallery -->
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head"><span><?php echo$content[0]['nom']?></span></h3>
