...
<!-- //js -->
<link rel="stylesheet" href="<?php echo css_loader('flexslider') ?>" type="text/css" media="screen" property="" />
<!-- font-awesome-icons -->
<link href="<?php echo css_loader('font-awesome.css')?>" rel="stylesheet"> 
<!-- //font-awesome-icons -->
						...
						<div class="shy-menu-panel">
							<nav class="menu menu--horatio link-effect-8" id="link-effect-8">
								<ul class="w3layouts_menu__list">
									...
									<li class="active"><a href="<?php echo site_url('ControllerPage/indexServices')?>">Services</a></li>
...
<!-- services -->
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head">Nos <span>Services</span> </h3>
			...
			<div class="w3_agile_services_grids"> 
				<div class="col-md-6 w3_agile_services_grid"> 
					<div class="col-xs-4 w3_agile_services_grid_left"> 
						<div class="agile_services_grid_left1 hvr-radial-out"> 
							<img src="<?php echo img_loader('13.png')?>" alt=" " class="img-responsive" />
						</div>
					</div>
				...
				<div class="col-md-6 w3_agile_services_grid"> 
					<div class="col-xs-4 w3_agile_services_grid_left"> 
						<div class="agile_services_grid_left1 hvr-radial-out"> 
							<img src="<?php echo img_loader('14.png')?>" alt=" " class="img-responsive" />
						</div>
					</div>
					<div class="col-xs-8 w3_agile_services_grid_right"> 
				...
				<div class="col-md-6 w3_agile_services_grid"> 
					<div class="col-xs-4 w3_agile_services_grid_left"> 
						<div class="agile_services_grid_left1 hvr-radial-out"> 
							<img src="<?php echo img_loader('15.png')?>" alt=" " class="img-responsive" />
						</div>
					</div>
					<div class="col-xs-8 w3_agile_services_grid_right"> 
				...
				<div class="col-md-6 w3_agile_services_grid"> 
					<div class="col-xs-4 w3_agile_services_grid_left"> 
						<div class="agile_services_grid_left1 hvr-radial-out"> 
							<img src="<?php echo img_loader('16.png')?>" alt=" " class="img-responsive" />
						</div>
					</div>
					<div class="col-xs-8 w3_agile_services_grid_right"> 
...
<!-- services-bottom -->
	<div class="services-bottom">
		<div class="container">
			...
			<div class="w3_agile_image">
				<img src="<?php echo img_loader('17.png')?>" alt=" " class="img-responsive">
			</div>
					...
					<div class="flexslider">
						<ul class="slides">
							<li>
								<div class="agile_testimonials_grid">
									<div class="col-md-4 agile_testimonials_grid_left">
										<img src="<?php echo img_loader('15.jpg')?>" alt=" " class="img-responsive" />
									</div>
							...
							<li>
								<div class="agile_testimonials_grid">
									<div class="col-md-4 agile_testimonials_grid_left">
										<img src="<?php echo img_loader('14.jpg')?>" alt=" " class="img-responsive" />
									</div>
									<div class="col-md-8 agile_testimonials_grid_right">
							...
							<li>
								<div class="agile_testimonials_grid">
									<div class="col-md-4 agile_testimonials_grid_left">
										<img src="<?php echo img_loader('16.jpg')?>" alt=" " class="img-responsive" />
									</div>
									<div class="col-md-8 agile_testimonials_grid_right">
										<h5>Vivamus malesuada <span>pellentesque</span> nunc id <i>'condim'</i></h5>
										<div class="wthree_stars">
			...
			<div class="w3agile_footer_grids">
				<div class="col-md-3 agileinfo_footer_grid">
					<div class="agileits_w3layouts_footer_logo">
						<h2><a href="<?php echo site_url('Accueil/index')?>"><span>A</span>griSolution<i>Grow healthy products</i></a></h2>
					</div>
				</div>
