...
<body>
	...
	<body>
		...
		<div class="breadcrumbs">
			<div class="container">
				<div class="w3layouts_breadcrumbs_left">
					<ul>
						<li><i class="fa fa-home" aria-hidden="true"></i><a href="<?php echo site_url('Accueil/index') ?>">Accueil</a></li>
						<li><i class="fa fa-home" aria-hidden="true"></i><a href="<?php echo base_url("/index.php/ControllerPage/indexInsertContenuCause")?>">Insertion Cause</a></li>
						<li><i class="fa fa-home" aria-hidden="true"></i><a href="<?php echo base_url("/index.php/ControllerPage/indexInsertContenuSolution")?>">Insertion Solution</a></li>
						<li><i class="fa fa-home" aria-hidden="true"></i><a href="<?php echo base_url("/index.php/ControllerPage/indexListeContenu")?>">Listes Contenus</a></li>
					</ul>
				</div>
				<div class="w3layouts_breadcrumbs_right">
					<a class="btn btn-danger" href="<?php echo site_url() ?>"> Deconnexion</a>
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
		...
		<?php if(isset($contenu)) include($contenu)?>
		<!-- //contact -->
				...
				<div class="w3agile_footer_grids">
					<div class="col-md-3 agileinfo_footer_grid">
						<div class="agileits_w3layouts_footer_logo">
							<h2><a href="index.html"><span>Le</span>monde<i>changement climatique </i></h2>
						</div>
					</div>
